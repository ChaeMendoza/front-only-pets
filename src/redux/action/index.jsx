...
export function getAllProductsBaneados() {
  return async function (dispatch) {
    try {
      const { data } = await axios.get(
              "https://back-only-pets-production.up.railway.app/products/restore/getban"
      );
      dispatch({
  ...
  return async function (dispatch) {
    try {
      const datos = await axios.delete(
              "https://back-only-pets-production.up.railway.app/products/unsubscribe/" + codProduct
      );
      dispatch({
        type: DELETE_PRODUCT,
        payload: codProduct,
...
export function postProductos(data) {
  return async (dispatch) => {
      const post = await axios.post("https://back-only-pets-production.up.railway.app/products/post", data);
    dispatch({
      type: POST_PRODUCT,
      payload: data,
    });
